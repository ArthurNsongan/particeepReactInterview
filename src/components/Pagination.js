...
function Pagination({perPage, currentPage, itemsLength, pageChanged}) {
    ...
    const displayNumbers = () => {
        let numbers = []
        numbers.push(<li key={0} onClick={prevPage} className="pagination-prev">Préc.</li>)
        ...
        numbers.push(<li key={numberPages + 1} onClick={nextPage} className="pagination-next">Suiv.</li>)
        return numbers
    }
